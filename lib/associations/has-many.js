...
var HasMany = function(source, target, options) {
  ...
  if (this.as) {
	...
	setForeignKeys.call(this,options);
...
HasMany.prototype.injectAttributes = function() {
  ...
  newAttributes[this.targetKey] = _.defaults({}, this.targetKeyAttribute, {
  ...
  Helpers.addForeignKeyConstraints(newAttributes[this.targetKey], this.source, this.target, constraintOptions, this.sourceField);
