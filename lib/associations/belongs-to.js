...
BelongsTo.prototype.injectAttributes = function() {
  ...
  newAttributes[this.sourceKey] = _.defaults({}, this.sourceKeyAttribute, {
    type: this.options.keyType || this.target.rawAttributes[this.targetKey].type,
    allowNull : true
  });

  if (this.options.constraints !== false) {
    var source = this.source.rawAttributes[this.sourceKey] || newAttributes[this.sourceKey];
    this.options.onDelete = this.options.onDelete || (source.allowNull ? 'SET NULL' : 'NO ACTION');
    this.options.onUpdate = this.options.onUpdate || 'CASCADE';
  }

  Helpers.addForeignKeyConstraints(newAttributes[this.sourceKey], this.target, this.source, this.options, this.targetField);
