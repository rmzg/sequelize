...
var BelongsTo = function(source, target, options) {
  ...
  if (this.as) {
	...
	var defaultSource = Utils.camelizeIf(
	...
	var defaultTarget = this.target.primaryKeyAttribute;
	var defaultSourceType = this.options.keyType || this.target.rawAttributes[this.target.primaryKeyAttribute || options.targetKey].type;

	this.targetAttribute = this.handleKeyOption( options.targetKey, this.target, defaultTarget);
	...
	this.sourceAttribute = this.handleKeyOption( options.sourceKey || options.foreignKey, this.source, defaultSource, defaultSourceType );
