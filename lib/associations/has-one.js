...
var HasOne = function(srcModel, targetModel, options) {
  ...
  if (this.as) {
	...
	var default_target = this.targetKey = Utils.camelizeIf(
		Utils.underscoredIf(this.as || Utils.singularize(this.source.name), this.target.options.underscored)
			+ '_' + this.source.primaryKeyAttribute,
		!this.source.options.underscored
	);
	var default_source = this.source.primaryKeyAttribute;
	var default_target_type = this.options.keyType || this.source.rawAttributes[this.source.primaryKeyAttribute || options.sourceKey].type;
