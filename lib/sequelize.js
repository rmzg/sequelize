...
Sequelize.prototype.define = function(modelName, attributes, options) { // testhint options:none
  ...
  if (globalOptions.define) {
    options = _.merge({}, globalOptions.define, options);
  }
...
Sequelize.prototype.query = function(sql, options) {
  ...
  if (options.model && options.mapToModel && !_.isEmpty(options.model.fieldAttributeMap)) {
  ...
  options = _.extend(_.clone(this.options.query), options);
